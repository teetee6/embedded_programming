...
const Triggering = function() {
  ...
  if(distance < 400) {
    ...
    else if(distance >= 5 && distance < 10)  LEDon( {r: 180, g:0, b:0}, 10 );
    else if(distance >= 10 && distance < 15)  LEDon( {r: 180, g:0, b:0}, 8 );
    else if(distance >= 15 && distance < 26)  LEDon( {r: 180, g:0, b:0}, 6 );
    else if(distance >= 26 && distance < 50)  LEDon( {r: 180, g:0, b:0}, 4 );
    else if(distance >= 50 && distance < 80)  LEDon( {r: 180, g:0, b:0}, 3 );
